...
If there is only one appendix, use the command \verb|\oneappendix|.  This command will make the next chapter %after the command
 ...
 %in the List of Tables and List of Figures, respectively, 
...
%The default behavior of this template is to exclude these entries.  To restore the inclusion of figures and tables in the List of Tables and List of Figures, respectively, include the following commands in the appendix.
%\begin{quote}
%\begin{verbatim}
