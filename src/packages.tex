...
\def \vsetlinux [#1]{\renewcommand{\FancyVerbFormatLine}[1]{{{\color{green} \$ }}#1}}
% DOS-like command prompt
\def \vsetdos [#1]{\renewcommand{\FancyVerbFormatLine}{{\color{blue}\texttt{C:\char`\\ >} }}}
% ROOT-like command prompt
\def \vsetroot [#1]{\renewcommand{\FancyVerbFormatLine}[1]{{\color{blue}root [\arabic{FancyVerbLine}] }#1}}
%reset
\def \vsetnone [#1]{\renewcommand{\FancyVerbFormatLine}[1]{#1}}
